            ...
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <a href="{{ url("$segment/$folder/add") }}"><button type="button"
                            class="btn btn-primary shadow-md mr-2">Add new data</button></a>
                </div>
            </div>
    ...
    <script>
        ...
        $(function() {
            ...
            oTable = $('#data-table').DataTable({
                ...
                columns:[
                    {data: 'DT_RowIndex',    title :'<center>No.</center>',   width:'10%', hozAlign: "center", vertAlign:"middle"}, // 0
                    {data: 'department',    title :'department', formatter:"html", vertAlign:"middle", hozAlign: "center", width:'25%',responsive:2}, // 1
                    {data: 'created_at',    title :'Create', formatter:"html", vertAlign:"middle",  hozAlign: "center",    width:'15%'}, // 2
                    {data: 'action',    title :'Action', formatter:"html", vertAlign:"middle",  hozAlign: "center",    width:'15%'}, // 2
                    ],
            });
