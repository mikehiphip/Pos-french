                            ...
                            <div class="intro-y box p-5">
                                <div class="grid grid-cols-12 gap-6 mt-5 mb-3">
                                    <div class="col-span-8 lg:col-span-6">
                                        ...
                                        <input type="text" id="name" name="tb_name" class="form-control w-full" placeholder="" required>
                                    </div>
                                    <div class="col-span-8 lg:col-span-6">
                                        <label for="validation-form-1" class="form-label w-full flex flex-col sm:flex-row text-primary"> Detail 
                                        </label>
                                        <input type="text" id="detail" name="detail" class="form-control w-full" placeholder="" >
                                    </div>
                                </div>
