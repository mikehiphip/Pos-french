        ...
        $(function() {
            ...
            oTable = $('#data-table').DataTable({
                ...
                columns:[
                    ...
                    {data: 'tb_name',    title :'Table', formatter:"html", vertAlign:"middle", hozAlign: "center", width:'20%',responsive:2}, // 2
                    {data: 'detail',    title :'Detail', formatter:"html", vertAlign:"middle", hozAlign: "center", width:'20%',responsive:2}, // 3
