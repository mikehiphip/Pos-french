            ...
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <a href="{{ url("$segment/$folder/add") }}"><button type="button"
                            class="btn btn-primary shadow-md mr-2">Add new customer</button></a>
                </div>
            </div>
        ...
        $(function() {
            ...
            oTable = $('#data-table').DataTable({
                ...
                columns:[
                    ...
                    {data: 'name',    title :'Name', formatter:"html", vertAlign:"middle", hozAlign: "center", width:'15%',responsive:2}, // 1
                    {data: 'company',    title :'Company', formatter:"html", vertAlign:"middle", hozAlign: "center", width:'15%',responsive:2}, // 2
                    {data: 'static',    title :'Static', formatter:"html", vertAlign:"middle", hozAlign: "center", width:'5%',responsive:2}, // 3
                    {data: 'note',    title :'Note', formatter:"html", vertAlign:"middle",  hozAlign: "center",    width:'10%'}, // 4
                    {data: 'order_note',    title :'Order Note', formatter:"html", vertAlign:"middle",  hozAlign: "center",    width:'15%'}, // 5
                    {data: 'action',    title :'Action', formatter:"html", vertAlign:"middle",  hozAlign: "center",    width:'10%'}, // 6
                    ],
            });
