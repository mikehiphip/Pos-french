            ...
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <a href="{{ url("$segment/$folder/add") }}"><button type="button"
                            class="btn btn-primary shadow-md mr-2">Add new employee</button></a>
                </div>
            </div>
        ...
        $(function() {
            ...
            oTable = $('#data-table').DataTable({
                ...
                columns:[
                    ...
                    {data: 'emp_code',    title :'Employee ID', formatter:"html", vertAlign:"middle", hozAlign: "center", width:'10%',responsive:2}, // 1
